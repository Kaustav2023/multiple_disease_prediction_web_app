...
diabetes_model=pickle.load(open('final_diabetes_model.sav','rb'))

heart_disease_model=pickle.load(open('final_heart_disease_model.sav','rb'))

parkinsons_model=pickle.load(open('final_parkinsons_model.sav','rb'))
